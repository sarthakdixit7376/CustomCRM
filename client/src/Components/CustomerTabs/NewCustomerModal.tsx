...
export default function NewCustomerModal({ isOpen, onClose, onSubmit }: NewCustomerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] bg-neutral-900/40 backdrop-blur-sm flex items-center justify-center p-6 animate-backdrop-fade-in max-sm:items-end max-sm:p-0" ref={backdropRef} onClick={handleBackdropClick}>
      <div className="w-full max-w-[680px] max-h-[90vh] bg-surface border border-border rounded-2xl flex flex-col overflow-hidden shadow-dropdown animate-modal-slide-up max-sm:max-w-full max-sm:max-h-full max-sm:rounded-t-2xl max-sm:rounded-b-none">
