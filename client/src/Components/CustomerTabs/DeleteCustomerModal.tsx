...
export default function DeleteCustomerModal({
  ...
  return (
    <div className="fixed inset-0 z-[1000] bg-neutral-900/40 backdrop-blur-sm flex items-center justify-center p-6 animate-backdrop-fade-in max-sm:items-end max-sm:p-0" ref={backdropRef} onClick={handleBackdropClick}>
      <div className="w-full max-w-[440px] bg-surface border border-border rounded-2xl flex flex-col overflow-hidden shadow-dropdown animate-modal-slide-up max-sm:max-w-full max-sm:rounded-t-2xl max-sm:rounded-b-none">
        ...
        <div className="p-6">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sm text-text-muted leading-relaxed max-w-[320px]">
              ...
              <span className="text-text font-semibold">"{customerName}"</span> and
        ...
        {/* ── Footer ── */}
        <div className="flex items-center justify-end gap-3 px-6 py-5 border-t border-border bg-neutral-50">
