...
import { getLeads, getLeadById, createLead, deleteLead, updateLeadFlowStatus, updateLeadAgent, updateLeadQuote, autoQuoteLead, getLiveComparisons, getCmaHandoff, generatePricingPdf, convertLeadToCustomer } from '../controllers/LeadController.js';
...
router.get('/:id/cma-handoff', getCmaHandoff);
